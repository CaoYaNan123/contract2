...
<body>
	...
	<div class="header">
		...
		<div class="dl-log">
			欢迎您，<span class="dl-log-user">${sessionScope.userInfo.u_cname }</span><a
		...
		<div class="dl-main-nav">
			...
			<ul id="J_Nav" class="nav-list ks-clear">
				<li class="nav-item dl-selected">
					<div class="nav-item-inner nav-home">合同管理</div>
				</li>
				<li class="nav-item">
					<div class="nav-item-inner nav-order">设备管理</div>
				</li>
				<li class="nav-item">
	...
	//{}是一个对象，[是一个数组]
		BUI.use('common/main', function() {
			var config = [ 
				...
				homePage : 'code',
				menu : [{    text : '合同维护',
						     items : [  { id : 'code', text : '报修单管理	', href : 'contract/bill.jsp', closeable : false }, 
				...
				id : 'user',
				menu : [{    text : '用户维护',
							 items : [  { id : 'code', text : '用户管理', href : 'user/usermanage.jsp' }, 
				...
				id : 'power',
				menu : [{    text : '权限维护',
							 items : [ {  id : 'introduce', text : '角色管理', href : 'user/role.jsp'  }, 
