	...
	<script type="text/javascript">
		BUI.use([ 'common/search', 'bui/overlay' ], 
			function(Search, Overlay) {
				...
				var store = Search.createStore('/contract2/Api/bill/billquery');
				var gridCfg = Search.createGridCfg(columns,{
					 			 tbar : {items : [{ 	text : '<i class="icon-plus"></i>新建',
				...
				function delItems(items) {
					...
					if (ids.length) {
						BUI.Message.Confirm('确认要删除选中的记录么？',
								function() {
									$.ajax({ url : '../data/del', dataType : 'json', data : { ids : ids },
